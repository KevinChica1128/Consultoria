...
~\\Estos archivos individuales se crearon para tener un análisis especifico por productor, también se debe registrar la cantidad inicial y la cantidad de pollos muertos, con esto se obtiene el porcentaje de mortalidad, se realiza la respectiva gráfica y finalmente se obtienen los intervalos los cuales también son gráficados.
